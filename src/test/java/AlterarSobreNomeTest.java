...
public class AlterarSobreNomeTest {
    ...
    public void testLogout() {
        ...
        MinhaContaPage minhaContaPage = new MinhaContaPage(driver);
        ...
        minhaContaPage.setSobreNome("Cornélio Procópio");
        minhaContaPage.buttonSalvar();
        takeScreenShot();

        assertEquals(minhaContaPage.getNotificacaoSalvar(), "Conta atualizada com sucesso.");
